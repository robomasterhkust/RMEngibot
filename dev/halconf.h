...
#define BUZZER_ON()     (palClearPad(GPIOB, GPIOB_PIN4_TIM3_BUZZER ))
#define BUZZER_OFF()    (palSetPad(GPIOB, GPIOB_PIN4_TIM3_BUZZER ))
#define BUZZER_TOGGLE() (palTogglePad(GPIOB, GPIOB_PIN4_TIM3_BUZZER ))
...
#define PN1_ON()        (palSetPad(GPIOH, GPIOH_PIN2_POWER1))
#define PN2_ON()        (palSetPad(GPIOH, GPIOH_PIN3_POWER2))
#define PN3_ON()        (palSetPad(GPIOH, GPIOH_PIN4_POWER3))
#define PN4_ON()        (palSetPad(GPIOH, GPIOH_PIN5_POWER4))
// #define PN5_ON()        (palSetPad(GPIOH, GPIOH_PNEUMATICS5))
// #define PN6_ON()        (palSetPad(GPIOI, GPIOI_PNEUMATICS6))
#define PN1_OFF()       (palClearPad(GPIOH, GPIOH_PIN2_POWER1))
#define PN2_OFF()       (palClearPad(GPIOH, GPIOH_PIN3_POWER2))
#define PN3_OFF()       (palClearPad(GPIOH, GPIOH_PIN4_POWER3))
#define PN4_OFF()       (palClearPad(GPIOH, GPIOH_PIN5_POWER4))
// #define PN5_OFF()       (palClearPad(GPIOH, GPIOH_PNEUMATICS5))
// #define PN6_OFF()       (palClearPad(GPIOI, GPIOI_PNEUMATICS6))
#define PN1_TOGGLE()    (palTogglePad(GPIOH, GPIOH_PIN2_POWER1))
#define PN2_TOGGLE()    (palTogglePad(GPIOH, GPIOH_PIN3_POWER2))
#define PN3_TOGGLE()    (palTogglePad(GPIOH, GPIOH_PIN4_POWER3))
#define PN4_TOGGLE()    (palTogglePad(GPIOH, GPIOH_PIN5_POWER4))
